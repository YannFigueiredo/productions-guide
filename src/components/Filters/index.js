...
export default function Filters({ type, show }) {
    ...
    return(
        <Container>
            <ContainerSelect>
                {show && genres && <Select options={genres} defaultSelected="Escolha um gênero" action="genres" label="genres" textLabel="Gênero"/>}
                {show && <Select options={sortOptions} defaultSelected="Escolha uma opção" action="sort" label="sort" textLabel="Ordenar por: "/>}
                {show && <Select options={years} defaultSelected="Escolha uma ano" action="years" label="years" textLabel="Ano: "/>}
            </ContainerSelect>
            <ContainerSearch>
